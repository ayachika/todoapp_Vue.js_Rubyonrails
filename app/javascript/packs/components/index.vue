  ...
  <div>
    ...
    <div class="row">
      <div class="col s10 m11">
        <input v-model="newTask" id="new-task-form" class="form-control" placeholder="Add your task!!">
      </div>
      <div class="col s2 m1">
    ...
    <div>
      <ul class="collection">
        <li v-for="task in tasks" v-if="!task.is_done" v-bind:id="'row_task_' + task.id" class="collection-item">
          ...
          <span v-bind:for="'task_' + task.id" class="word-color-black">{{ task.name }}</span>
          </label>
